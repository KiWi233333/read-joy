...
public class AdminResourceController {
    ...
    Result<ResourceVO> getResourceDetail(
        ...
        return Result.ok(bookService.getResourceDetail(id));
    }
    ...
    Result<Integer> addResource(
        ...
        return Result.ok(bookService.addResource(dto));
    }
    ...
    Result<Integer> updateResource(
        ...
        return Result.ok(bookService.updateResource(id, dto));
    }
    ...
    Result<Integer> deleteResource(
            @RequestHeader(name = HEADER_NAME) String token,
            @PathVariable("id") Integer id) {
        return Result.ok(bookService.batchDeleteResource(new Integer[]{id}));
    }
    ...
    Result<Integer> batchDeleteResource(
        ...
        return Result.ok(bookService.batchDeleteResource(ids));
    }
